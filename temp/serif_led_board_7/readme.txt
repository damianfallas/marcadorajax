...
True Type Font: Serif LED Board-7 version 1.0


EULA
-==-
The font Serif LED Board-7 is freeware for home using only.


DESCRIPTION
-=========-
This is original font created in style a LED (Light Emitting Diode) matrix 8*5 units. Latin and Cyrillic code pages are supported.

Files in serif_led_board-7.zip:
       	readme.txt     				this file;
        serif_led_board-7.ttf    		regular true type font;
	serif_led_board-7_screen.png		preview image.
